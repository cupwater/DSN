...
class Domain_shared_encoder(nn.Module):
    def __init__(self, n_class=10):
        super(Domain_shared_encoder, self).__init__()
        ################################
...
class Domain_specific_encoder(nn.Module):
    def __init__(self, code_size=128,  self).__init__()
...
# we can drop it
class Domain_shared_decoder(nn.Module):
    def __init__(self):
        super(Domain_shared_decoder, self).__init__()
        ######################################
...
class Domain_specific_decoder(nn.Module):
    def __init__(self):
        super(Domain_shared_decoder, self).__init__()


# we use mnist to verify the idea
class dsn_mnist(nn.Module):
    def __init__(self, =100, n_domains=2, n_class=10):
